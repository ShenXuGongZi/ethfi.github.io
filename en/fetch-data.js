...
function calculateAirdrop() {
    ...
    document.getElementById('result').innerHTML = "Airdrop amount is: " + Math.round(airdropAmount) + " ethfi tokens";
    } else {
    document.getElementById('result').innerHTML = "Please ensure the total score is greater than 0 and the input is a valid number.";
    }
}